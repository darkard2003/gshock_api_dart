/// Constants mirroring `gshock_api/src/gshock_api/casio_constants.py`.
///
/// Holds BLE characteristic UUIDs, static handles and the characteristic
/// command/feature codes used across the library.
class CasioConstants {
  ...
  static const int handleSpNotify = 0x15; // enable notifications (write 0x0100)
  static const int handleSpRequest = 0x17; // write-without-response
  static const int handleSpData = 0x19; // write-with-response + notify
